...
namespace Lpfm.LastFmScrobbler.Api
{
    ...
    internal interface IRestApi
    {
        ...
        XPathNavigator SendGetRequest(string url, SortedDictionary<string, string> queryItems);
        ...
        /// <returns>A read-only XPath queryable <see cref="XPathNavigator"/></returns>
        XPathNavigator SendPostRequest(string url, SortedDictionary<string, string> formItems);
